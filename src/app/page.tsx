  ...
  return (
    <main className="min-h-screen bg-[#0a0e1a] relative overflow-hidden">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-[1800px] mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-emerald-500 rounded-xl blur-lg opacity-75"></div>
        ...
        {/* Main Content */}
        <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 p-6 h-[calc(100vh-140px)]">
          {/* Left Panel */}
          <div className="space-y-6 overflow-auto scrollbar-thin scrollbar-thumb-cyan-500/20 scrollbar-track-transparent">
            <div className="relative group">
              ...
              <div className="relative bg-slate-900/50 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6">
                <h2 className="text-lg font-semibold mb-4 flex items-center gap-2 text-slate-100">
                  <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500 to-emerald-500 flex items-center justify-center">
            ...
            {data && (
              <div className="space-y-3">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-xl blur-lg group-hover:blur-xl transition-all"></div>
                  <div className="relative bg-slate-900/50 backdrop-blur-xl border border-emerald-500/20 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-slate-200 mb-1">Technical Specification</h3>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-slate-900/50 backdrop-blur-xl border border-cyan-500/20 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-slate-200 mb-1">Architecture</h3>
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-emerald-500/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all"></div>
            <div className="relative bg-slate-900/50 backdrop-blur-xl border border-cyan-500/20 rounded-2xl overflow-hidden h-full">
              {data ? (
                <CodeViewer code={data.jsx} test={data.test} />
              ) : (
                <div className="h-full flex flex-col items-center justify-center text-center p-12">
                  <div className="relative mb-6">
                    <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-emerald-500 rounded-2xl blur-2xl opacity-50"></div>
                    <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-500 to-emerald-500 flex items-center justify-center">
                      <svg className="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                      </svg>
                    </div>
                  </div>
                  <h3 className="text-lg font-semibold text-slate-200 mb-2">Ready to Build</h3>
                  <p className="text-sm text-slate-400 max-w-sm">Describe your application and watch AI create it in real-time with streaming</p>
                </div>
              )}
            </div>
          </div>
        ...
        {/* Footer */}
        <footer className="border-t border-cyan-500/10 backdrop-blur-xl bg-slate-950/50 py-4">
